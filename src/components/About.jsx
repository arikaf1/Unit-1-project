...
function About() {
  return (
    <div style={{ padding: '24px', maxWidth: '700px', margin: '0 auto', fontFamily: 'sans-serif', lineHeight: '1.6' }}>
      ...
      <p>
        This <strong>Job Hunt Application</strong> was designed to give applicants total visibility upfront. 
      ...
      <h3>Contact Us</h3>
      <p>Have questions or feedback about our platform? Reach out at <strong>support@jobhuntapp.com</strong>.</p>
    </div>
  );
}
